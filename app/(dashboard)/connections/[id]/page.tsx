      ...
      <Card className="glass-card overflow-hidden">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            <div className="relative h-20 w-20 overflow-hidden rounded-full border border-white/10 bg-background/40 shrink-0">
              {channel.pictureUrl ? (
              ...
              <div className="space-y-3">
                {channel.assignments.length === 0 ? (
                  ...
                  channel.assignments.map((assignment) => (
                    <div key={assignment.id} className="rounded-xl border bg-background/30 p-4">
            ...
            <div className="space-y-3">
              {channel.requests.length === 0 ? (
                ...
                channel.requests.map((request) => (
                  <div key={request.id} className="rounded-xl border bg-background/30 p-4 flex flex-col gap-2">
